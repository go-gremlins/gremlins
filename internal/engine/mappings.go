...
var TokenMutantType = map[token.Token][]mutator.Type{
	...
	token.AND_ASSIGN:     {mutator.RemoveSelfAssignments},
	token.AND_NOT:        {mutator.InvertBitwise},
	token.AND_NOT_ASSIGN: {mutator.RemoveSelfAssignments},
	...
	token.OR_ASSIGN:      {mutator.RemoveSelfAssignments},
	...
	token.SHL_ASSIGN:     {mutator.RemoveSelfAssignments},
	token.SHR:            {mutator.InvertBitwise},
	token.SHR_ASSIGN:     {mutator.RemoveSelfAssignments},
	...
	token.XOR_ASSIGN:     {mutator.RemoveSelfAssignments},
}
